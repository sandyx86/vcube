...
typedef struct gx__GuVector gx__GuVector;
typedef struct gx__GuQuaternion gx__GuQuaternion;
typedef struct gx__Argv gx__Argv;
typedef struct gx__GXRModeObj gx__GXRModeObj;
typedef union gx__WGPipe gx__WGPipe;
typedef struct gx__GXColor gx__GXColor;
typedef struct gx__GXColorS10 gx__GXColorS10;
typedef struct gx__GXTexObj gx__GXTexObj;
typedef struct gx__GXTlutObj gx__GXTlutObj;
typedef struct gx__GXTexRegion gx__GXTexRegion;
typedef struct gx__GXTlutRegion gx__GXTlutRegion;
typedef struct gx__GXLightObj gx__GXLightObj;
typedef struct gx__Vtx gx__Vtx;
typedef struct gx__GXVtxDesc gx__GXVtxDesc;
typedef struct gx__GXVtxAttrFmt gx__GXVtxAttrFmt;
typedef struct gx__GXFifoObj gx__GXFifoObj;
typedef struct gx__GXTexReg gx__GXTexReg;
typedef struct gx__GXFogAdjTbl gx__GXFogAdjTbl;
typedef struct video__Argv video__Argv;
typedef struct sys__Argv sys__Argv;
typedef struct sys__Alarmcallback sys__Alarmcallback;
typedef struct sys__Resetcallback sys__Resetcallback;
typedef struct main__Lldiv_t main__Lldiv_t;
typedef struct main__Random_data main__Random_data;
typedef struct main__Drand48_data main__Drand48_data;
typedef struct main__Mallinfo main__Mallinfo;
typedef struct main__Mallinfo2 main__Mallinfo2;
...
typedef enum {
	main__Uint8_t__fp_nan = 0, // 0
	main__Uint8_t__fp_infinite = 1, // 1
	main__Uint8_t__fp_zero = 2, // 2
	main__Uint8_t__fp_subnormal = 3, // 3
	main__Uint8_t__fp_normal = 4, // 4
}  main__Uint8_t;
...
typedef u16 Array_fixed_u16_3 [3];
typedef map Map_string_int;
typedef u8 Array_fixed_u8_2 [2];
typedef u8 Array_fixed_u8_7 [7];
typedef f32 Array_fixed_f32_4 [4];
typedef f32 Array_fixed_f32_3 [3];
typedef u32 Array_fixed_u32_8 [8];
typedef u32 Array_fixed_u32_3 [3];
typedef u32 Array_fixed_u32_4 [4];
typedef u32 Array_fixed_u32_16 [16];
typedef u8 Array_fixed_u8_128 [128];
typedef u8 Array_fixed_u8_4 [4];
typedef u16 Array_fixed_u16_10 [10];
typedef u8 Array_fixed_u8_12 [12];
typedef u16 Array_fixed_u16_4 [4];
typedef array Array_i8_ptr;
...
typedef f32 (*anon_fn___f32)();
typedef void (*gx__GXBreakPtCallback)();
typedef void (*gx__GXDrawDoneCallback)();
typedef void (*gx__GXDrawSyncCallback)(u16);
typedef gx__GXTexRegion* (*gx__GXTexRegionCallback)(gx__GXTexObj*,u8);
typedef gx__GXTlutRegion* (*gx__GXTlutRegionCallback)(u32);
typedef void (*video__VIRetraceCallback)(u32);
typedef void (*video__VIPositionCallback)(u32,u32);
typedef void (*sys__Powercallback)();
typedef i32 (*sys__Resetfunction)(i32);
...
struct main__Lldiv_t {
	i64 quot;
	i64 rem;
};

struct main__Random_data {
	int* fptr;
	int* rptr;
	int* state;
	int rand_type;
...
typedef f32 (*Array_fixed_anon_fn___f32_4[4]) ();
...
typedef f32 (*Array_fixed_anon_fn___f32_3[3]) ();
...
struct gx__GXVtxDesc {
	u8 attr;
	u8 type_;
};

struct gx__GXVtxAttrFmt {
	u32 vtxattr;
	u32 comptype;
	u32 compsize;
	u32 frac;
...
struct main__Drand48_data {
	Array_fixed_u16_3 __x;
	Array_fixed_u16_3 __old_x;
	u16 __c;
	u16 __init;
	i64 __a;
};
typedef Array_fixed_u8_2 Array_fixed_Array_fixed_u8_2_12 [12];
typedef Array_fixed_f32_4 Array_fixed_Array_fixed_f32_4_3 [3];
typedef Array_fixed_f32_3 Array_fixed_Array_fixed_f32_3_4 [4];
typedef Array_fixed_f32_3 Array_fixed_Array_fixed_f32_3_3 [3];
typedef Array_fixed_f32_4 Array_fixed_Array_fixed_f32_4_4 [4];

struct gx__GXTexObj {
	Array_fixed_u32_8 val;
};

struct gx__GXTlutObj {
	Array_fixed_u32_3 val;
};

struct gx__GXTexRegion {
	Array_fixed_u32_4 val;
};

struct gx__GXTlutRegion {
	Array_fixed_u32_4 val;
};

struct gx__GXLightObj {
	Array_fixed_u32_16 val;
};

struct gx__GXFifoObj {
	Array_fixed_u8_128 pad;
};

struct gx__GXTexReg {
	Array_fixed_u8_4 dummy;
};

struct gx__GXFogAdjTbl {
	Array_fixed_u16_10 r;
};
typedef Array_fixed_u8_12 Array_fixed_Array_fixed_u8_12_2 [2];

struct gx__GXRModeObj {
	u32 viTVMode;
	u16 fbWidth;
	u16 efbHeight;
	u16 xfbHeight;
	...
	u8 field_rendering;
	u8 aa;
	Array_fixed_Array_fixed_u8_2_12 sample_pattern;
	Array_fixed_u8_7 vfilter;
};

struct sys__Alarmcallback {
	Array_fixed_Array_fixed_u8_12_2 flash_id;
	u32 wirelessKbd_id;
	Array_fixed_u16_4 wirelessPad_id;
	u8 dvderr_code;
	u8 __padding0;
	Array_fixed_u8_2 flashID_chksum;
	u16 gbs;
	u16 __padding1;
};
// #end sorted_symbols
...
typedef Array_fixed_Array_fixed_f32_3_3 gx__Mtx33;
typedef Array_fixed_anon_fn___f32_3 gx__Mtx33P;
typedef Array_fixed_Array_fixed_f32_4_4 gx__Mtx44;
typedef Array_fixed_anon_fn___f32_4 gx__Mtx44P;
...
VV_LOCAL_SYMBOL  int compare_10994457055883448334_RepIndex_by_idx(RepIndex* a, RepIndex* b) {
...
void guFrustum(Array_fixed_anon_fn___f32_4 mt, f32 t, f32 b, f32 l, f32 r, f32 n, f32 f);
void guPerspective(Array_fixed_anon_fn___f32_4 mt, f32 fovy, f32 aspect, f32 n, f32 f);
void guOrtho(Array_fixed_anon_fn___f32_4 mt, f32 t, f32 b, f32 l, f32 r, f32 n, f32 f);
void guLightPerspective(Array_fixed_anon_fn___f32_4 mt, f32 fovy, f32 aspect, f32 scales, f32 scalet, f32 transs, f32 transt);
void guLightOrtho(Array_fixed_anon_fn___f32_4 mt, f32 t, f32 b, f32 l, f32 r, f32 scales, f32 scalet, f32 transs, f32 transt);
void guLightFrustum(Array_fixed_anon_fn___f32_4 mt, f32 t, f32 b, f32 l, f32 r, f32 n, f32 scales, f32 scalet, f32 transs, f32 transt);
void guLookAt(Array_fixed_anon_fn___f32_4 mt, gx__GuVector* campos, gx__GuVector* camup, gx__GuVector* target);
void guVecHalfAngle(gx__GuVector* a, gx__GuVector* b, gx__GuVector* half);
void guVecAdd(gx__GuVector* a, gx__GuVector* b, gx__GuVector* ab);
void guVecSub(gx__GuVector* a, gx__GuVector* b, gx__GuVector* ab);
void guVecScale(gx__GuVector* src, gx__GuVector* dst, f32 scale);
void guVecNormalize(gx__GuVector* v);
void guVecMultiply(Array_fixed_anon_fn___f32_4 mt, gx__GuVector* src, gx__GuVector* dst);
void guVecCross(gx__GuVector* a, gx__GuVector* b, gx__GuVector* axb);
void guVecMultiplySR(Array_fixed_anon_fn___f32_4 mt, gx__GuVector* src, gx__GuVector* dst);
f32 guVecDotProduct(gx__GuVector* a, gx__GuVector* b);
void guQuatAdd(gx__GuQuaternion* a, gx__GuQuaternion* b, gx__GuQuaternion* ab);
void guQuatSub(gx__GuQuaternion* a, gx__GuQuaternion* b, gx__GuQuaternion* ab);
void guQuatMultiply(gx__GuQuaternion* a, gx__GuQuaternion* b, gx__GuQuaternion* ab);
void guQuatNormalize(gx__GuQuaternion* a, gx__GuQuaternion* d);
void guQuatInverse(gx__GuQuaternion* a, gx__GuQuaternion* d);
void guQuatMtx(gx__GuQuaternion* a, Array_fixed_anon_fn___f32_4 m);
void guMtxIdentity(Array_fixed_anon_fn___f32_4 mt);
void guMtxCopy(Array_fixed_anon_fn___f32_4 src, Array_fixed_anon_fn___f32_4 dst);
void guMtxConcat(Array_fixed_anon_fn___f32_4 a, Array_fixed_anon_fn___f32_4 b, Array_fixed_anon_fn___f32_4 ab);
void guMtxScale(Array_fixed_anon_fn___f32_4 mt, f32 xs, f32 ys, f32 zs);
void guMtxScaleApply(Array_fixed_anon_fn___f32_4 src, Array_fixed_anon_fn___f32_4 dst, f32 xs, f32 ys, f32 zs);
void guMtxApplyScale(Array_fixed_anon_fn___f32_4 src, Array_fixed_anon_fn___f32_4 dst, f32 xs, f32 ys, f32 zs);
void guMtxTrans(Array_fixed_anon_fn___f32_4 mt, f32 xt, f32 yt, f32 zt);
void guMtxTransApply(Array_fixed_anon_fn___f32_4 src, Array_fixed_anon_fn___f32_4 dst, f32 xt, f32 yt, f32 zt);
void guMtxApplyTrans(Array_fixed_anon_fn___f32_4 src, Array_fixed_anon_fn___f32_4 dst, f32 xt, f32 yt, f32 zt);
u32 guMtxInverse(Array_fixed_anon_fn___f32_4 src, Array_fixed_anon_fn___f32_4 inv);
u32 guMtxInvXpose(Array_fixed_anon_fn___f32_4 src, Array_fixed_anon_fn___f32_4 xpose);
void guMtxTranspose(Array_fixed_anon_fn___f32_4 src, Array_fixed_anon_fn___f32_4 xpose);
void guMtxRotRad(Array_fixed_anon_fn___f32_4 mt, i8 axis, f32 rad);
void guMtxRotTrig(Array_fixed_anon_fn___f32_4 mt, i8 axis, f32 sina, f32 cosa);
void guMtxRotAxisRad(Array_fixed_anon_fn___f32_4 mt, gx__GuVector* axis, f32 rad);
void guMtxReflect(Array_fixed_anon_fn___f32_4 m, gx__GuVector* p, gx__GuVector* n);
void guMtxQuat(Array_fixed_anon_fn___f32_4 m, gx__GuQuaternion* a);
void guMtx44Identity(Array_fixed_anon_fn___f32_4 mt);
void guMtx44Copy(Array_fixed_anon_fn___f32_4 src, Array_fixed_anon_fn___f32_4 dst);
u32 guMtx44Inverse(Array_fixed_anon_fn___f32_4 src, Array_fixed_anon_fn___f32_4 inv);
gx__GXFifoObj* GX_Init(voidptr base, u32 size);
void GX_InitFifoBase(gx__GXFifoObj* fifo, voidptr base, u32 size);
void GX_InitFifoLimits(gx__GXFifoObj* fifo, u32 hiwatermark, u32 lowatermark);
void GX_InitFifoPtrs(gx__GXFifoObj* fifo, voidptr rd_ptr, voidptr wt_ptr);
void GX_GetFifoPtrs(gx__GXFifoObj* fifo, voidptr* rd_ptr, voidptr* wt_ptr);
void GX_SetCPUFifo(gx__GXFifoObj* fifo);
void GX_SetGPFifo(gx__GXFifoObj* fifo);
void GX_GetCPUFifo(gx__GXFifoObj* fifo);
void GX_GetGPFifo(gx__GXFifoObj* fifo);
voidptr GX_GetFifoBase(gx__GXFifoObj* fifo);
u32 GX_GetFifoCount(gx__GXFifoObj* fifo);
u32 GX_GetFifoSize(gx__GXFifoObj* fifo);
u8 GX_GetFifoWrap(gx__GXFifoObj* fifo);
gx__GXDrawDoneCallback GX_SetDrawDoneCallback(void (*cb)());
gx__GXBreakPtCallback GX_SetBreakPtCallback(void (*cb)());
void GX_AbortFrame();
void GX_Flush();
...
gx__GXDrawSyncCallback GX_SetDrawSyncCallback(void (*cb)(u16 ));
void GX_DisableBreakPt();
void GX_EnableBreakPt(voidptr break_pt);
void GX_DrawDone();
void GX_TexModeSync();
void GX_InvVtxCache();
void GX_ClearVtxDesc();
void GX_LoadProjectionMtx(Array_fixed_anon_fn___f32_4 mt, u8 type_);
...
void GX_SetChanCtrl(i32 channel, u8 enable, u8 ambsrc, u8 matsrc, u8 litmask, u8 diff_fn, u8 attn_fn);
void GX_SetChanAmbColor(i32 channel, gx__GXColor color);
void GX_SetChanMatColor(i32 channel, gx__GXColor color);
void GX_SetArray(u32 attr, voidptr ptr, u8 stride);
void GX_SetVtxAttrFmt(u8 vtxfmt, u32 vtxattr, u32 comptype, u32 compsize, u32 frac);
void GX_SetVtxAttrFmtv(u8 vtxfmt, gx__GXVtxAttrFmt* attr_list);
void GX_SetVtxDesc(u8 attr, u8 type_);
void GX_SetVtxDescv(gx__GXVtxDesc* attr_list);
void GX_GetVtxDescv(gx__GXVtxDesc* attr_list);
u32 GX_EndDispList();
void GX_Begin(u8 primitve, u8 vtxfmt, u16 vtxcnt);
void GX_BeginDispList(voidptr list, u32 size);
void GX_CallDispList(voidptr list, u32 nbytes);
void GX_End(void);
void GX_Position3f32(f32 x, f32 y, f32 z);
void GX_Position3u16(u16 x, u16 y, u16 z);
void GX_Position3i16(i16 x, i16 y, i16 z);
void GX_Position3u8(u8 x, u8 y, u8 z);
void GX_Position3i8(i8 x, i8 y, i8 z);
void GX_Position2f32(f32 x, f32 y);
void GX_Position2u16(u16 x, u16 y);
void GX_Position2i16(i16 x, i16 y);
void GX_Position2u8(u8 x, u8 y);
void GX_Position2i8(i8 x, i8 y);
void GX_Position1x8(u8 index);
void GX_Position1x16(u16 index);
void GX_Normal3f32(f32 nx, f32 ny, f32 nz);
void GX_Normal3i16(i16 nx, i16 ny, i16 nz);
void GX_Normal3i8(i8 nx, i8 ny, i8 nz);
...
void GX_TexCoord2i16(i16 s, i16 t);
void GX_TexCoord2u8(u8 s, u8 t);
void GX_TexCoord2i8(i8 s, i8 t);
void GX_TexCoord1f32(f32 s);
void GX_TexCoord1u16(u16 s);
void GX_TexCoord1i16(i16 s);
void GX_TexCoord1u8(u8 s);
void GX_TexCoord1i8(i8 s);
void GX_TexCoord1x8(u8 index);
void GX_TexCoord1x16(u16 index);
void GX_MatrixIndex1x8(u8 index);
void GX_AdjustForOverscan(gx__GXRModeObj* rmin, gx__GXRModeObj* rmout, u16 hor, u16 ver);
void GX_LoadPosMtxImm(Array_fixed_anon_fn___f32_4 mt, u32 pnidx);
void GX_LoadPosMtxIdx(u16 mtxidx, u32 pnidx);
void GX_LoadNrmMtxImm(Array_fixed_anon_fn___f32_4 mt, u32 pnidx);
void GX_LoadNrmMtxImm3x3(Array_fixed_anon_fn___f32_3 mt, u32 pnidx);
void GX_LoadNrmMtxIdx3x3(u16 mtxidx, u32 pnidx);
void GX_LoadTexMtxImm(Array_fixed_anon_fn___f32_4 mt, u32 texidx, u8 type_);
void GX_LoadTexMtxIdx(u16 mtxidx, u32 texidx, u8 type_);
void GX_SetCurrentMtx(u32 mtx);
void GX_SetTevOp(u8 tevstage, u8 mode);
void GX_SetTevColor(u8 tev_regid, gx__GXColor color);
void GX_SetTevColorS10(u8 tev_regid, gx__GXColorS10 color);
...
void GX_SetBlendMode(u8 type_, u8 src_fact, u8 dst_fact, u8 op);
...
void GX_SetScissorBoxOffset(i32 xoffset, i32 yoffset);
...
void GX_SetTevKColor(u8 sel, gx__GXColor col);
void GX_SetTevKColorSel(u8 tevstage, u8 sel);
void GX_SetTevKAlphaSel(u8 tevstage, u8 sel);
void GX_SetTevKColorS10(u8 sel, gx__GXColorS10 col);
...
void GX_SetFog(u8 type_, f32 startz, f32 endz, f32 nearz, f32 farz, gx__GXColor col);
void GX_SetFogRangeAdj(u8 enable, u16 center, gx__GXFogAdjTbl* table);
void GX_SetFogColor(gx__GXColor color);
void GX_InitFogAdjTable(gx__GXFogAdjTbl* table, u16 width, Array_fixed_anon_fn___f32_4 projmtx);
void GX_SetIndTexMatrix(u8 indtexmtx, Array_fixed_anon_fn___f32_3 offset_mtx, i8 scale_exp);
...
void GX_SetCopyFilter(u8 aa, Array_fixed_Array_fixed_u8_2_12 sample_pattern, u8 vf, u8* vfilter);
void GX_SetDispCopyFrame2Field(u8 mode);
void GX_SetCopyClear(gx__GXColor color, u32 zvalue);
void GX_CopyDisp(voidptr dest, u8 clear);
void GX_SetTexCopySrc(u16 left, u16 top, u16 wd, u16 ht);
void GX_SetTexCopyDst(u16 wd, u16 ht, u32 fmt, u8 mipmap);
void GX_CopyTex(voidptr dest, u8 clear);
void GX_PixModeSync();
...
void GX_PokeBlendMode(u8 type_, u8 src_fact, u8 dst_fact, u8 op);
void GX_PokeAlphaRead(u8 mode);
void GX_PokeDstAlpha(u8 enable, u8 a);
void GX_PokeARGB(u16 x, u16 y, gx__GXColor color);
void GX_PeekARGB(u16 x, u16 y, gx__GXColor* color);
void GX_PokeZ(u16 x, u16 y, u32 z);
void GX_PeekZ(u16 x, u16 y, u32* z);
void GX_PokeZMode(u8 comp_enable, u8 func, u8 update_enable);
u32 GX_GetTexObjFmt(gx__GXTexObj* obj);
u32 GX_GetTexObjMipMap(gx__GXTexObj* obj);
voidptr GX_GetTexObjUserData(gx__GXTexObj* obj);
voidptr GX_GetTexObjData(gx__GXTexObj* obj);
u8 GX_GetTexObjWrapS(gx__GXTexObj* obj);
u8 GX_GetTexObjWrapT(gx__GXTexObj* obj);
u16 GX_GetTexObjHeight(gx__GXTexObj* obj);
u16 GX_GetTexObjWidth(gx__GXTexObj* obj);
void GX_GetTexObjAll(gx__GXTexObj* obj, voidptr* image_ptr, u16* width, u16* height, u8* format, u8* wrap_s, u8* wrap_t, u8* mipmap);
u32 GX_GetTexBufferSize(u16 wd, u16 ht, u32 fmt, u8 mipmap, u8 maxlod);
void GX_InvalidateTexAll();
void GX_InvalidateTexRegion(gx__GXTexRegion* region);
void GX_InitTexCacheRegion(gx__GXTexRegion* region, u8 ii32bmipmap, u32 tmem_even, u8 size_even, u32 tmem_odd, u8 size_odd);
void GX_InitTexPreloadRegion(gx__GXTexRegion* region, u32 tmem_even, u32 size_even, u32 tmem_odd, u32 size_odd);
void GX_InitTexObj(gx__GXTexObj* obj, voidptr img_ptr, u16 wd, u16 ht, u8 fmt, u8 wrap_s, u8 wrap_t, u8 mipmap);
void GX_InitTexObjCI(gx__GXTexObj* obj, voidptr img_ptr, u16 wd, u16 ht, u8 fmt, u8 wrap_s, u8 wrap_t, u8 mipmap, u32 tlut_name);
void GX_InitTexObjTlut(gx__GXTexObj* obj, u32 tlut_name);
void GX_InitTexObjData(gx__GXTexObj* obj, voidptr img_ptr);
void GX_InitTexObjWrapMode(gx__GXTexObj* obj, u8 wrap_s, u8 wrap_t);
void GX_InitTexObjFilterMode(gx__GXTexObj* obj, u8 minfilt, u8 magfilt);
void GX_InitTexObjMinLOD(gx__GXTexObj* obj, f32 minlod);
void GX_InitTexObjMaxLOD(gx__GXTexObj* obj, f32 maxlod);
void GX_InitTexObjLODBias(gx__GXTexObj* obj, f32 lodbias);
void GX_InitTexObjBiasClamp(gx__GXTexObj* obj, u8 biasclamp);
void GX_InitTexObjEdgeLOD(gx__GXTexObj* obj, u8 edgelod);
void GX_InitTexObjMaxAniso(gx__GXTexObj* obj, u8 maxaniso);
void GX_InitTexObjUserData(gx__GXTexObj* obj, voidptr userdata);
void GX_LoadTexObj(gx__GXTexObj* obj, u8 mapid);
void GX_LoadTlut(gx__GXTlutObj* obj, u32 tlut_name);
void GX_LoadTexObjPreloaded(gx__GXTexObj* obj, gx__GXTexRegion* region, u8 mapid);
void GX_PreloadEntireTexture(gx__GXTexObj* obj, gx__GXTexRegion* region);
void GX_InitTlutObj(gx__GXTlutObj* obj, voidptr lut, u8 fmt, u16 entries);
void GX_InitTlutRegion(gx__GXTlutRegion* region, u32 tmem_addr, u8 tlut_sz);
void GX_InitTexObjLOD(gx__GXTexObj* obj, u8 minfilt, u8 magfilt, f32 minlod, f32 maxlod, f32 lodbias, u8 biasclamp, u8 edgelod, u8 maxaniso);
...
gx__GXTexRegionCallback GX_SetTexRegionCallback(gx__GXTexRegion* (*cb)(gx__GXTexObj* , u8 ));
gx__GXTlutRegionCallback GX_SetTlutRegionCallback(gx__GXTlutRegion* (*cb)(u32 ));
void GX_InitLightPos(gx__GXLightObj* lit_obj, f32 x, f32 y, f32 z);
void GX_InitLightColor(gx__GXLightObj* lit_obj, gx__GXColor col);
void GX_InitLightDir(gx__GXLightObj* lit_obj, f32 nx, f32 ny, f32 nz);
void GX_LoadLightObj(gx__GXLightObj* lit_obj, u8 lit_id);
void GX_LoadLightObjIdx(u32 litobjidx, u8 litid);
void GX_InitLightDistAttn(gx__GXLightObj* lit_obj, f32 ref_dist, f32 ref_brite, u8 dist_fn);
void GX_InitLightAttn(gx__GXLightObj* lit_obj, f32 a0, f32 a1, f32 a2, f32 k0, f32 k1, f32 k2);
void GX_InitLightAttnA(gx__GXLightObj* lit_obj, f32 a0, f32 a1, f32 a2);
void GX_InitLightAttnK(gx__GXLightObj* lit_obj, f32 k0, f32 k1, f32 k2);
void GX_InitSpecularDirHA(gx__GXLightObj* lit_obj, f32 nx, f32 ny, f32 nz, f32 hx, f32 hy, f32 hz);
void GX_InitSpecularDir(gx__GXLightObj* lit_obj, f32 nx, f32 ny, f32 nz);
void GX_InitLightSpot(gx__GXLightObj* lit_obj, f32 cut_off, u8 spotfn);
...
voidptr GX_RedirectWriteGatherPipe(voidptr ptr);
voidptr VIDEO_GetNextFramebuffer();
voidptr VIDEO_GetCurrentFramebuffer();
void VIDEO_Init();
void VIDEO_Flush();
...
void VIDEO_Configure(gx__GXRModeObj* rmode);
u32 VIDEO_GetFrameBufferSize(gx__GXRModeObj* rmode);
void VIDEO_ClearFrameBuffer(gx__GXRModeObj* rmode, voidptr fb, u32 color);
void VIDEO_WaitVSync();
void VIDEO_SetNextFramebuffer(voidptr fb);
void VIDEO_SetNextRightFramebuffer(voidptr fb);
video__VIRetraceCallback VIDEO_SetPreRetraceCallback(void (*callback)(u32 ));
video__VIRetraceCallback VIDEO_SetPostRetraceCallback(void (*callback)(u32 ));
u32 VIDEO_HaveComponentCable();
gx__GXRModeObj* VIDEO_GetPreferredMode(gx__GXRModeObj* mode);
u32 VIDEO_GetVideoScanMode();
void SYS_Init();
voidptr SYS_AllocateFramebuffer(gx__GXRModeObj* rmode);
void SYS_ProtectRange(u32 chan, voidptr addr, u32 bytes, u32 cntrl);
...
i8 SYS_GetDisplayOffsetH();
void SYS_SetDisplayOffsetH(i8 offset);
u8 SYS_GetEuRGB60();
...
void SYS_GetFontTexture(i32 c, voidptr* image, i32* xpos, i32* ypos, i32* width);
void SYS_GetFontTexel(i32 c, voidptr image, i32 pos, i32 stride, i32* width);
void SYS_ResetSystem(i32 reset, u32 reset_code, i32 force_menu);
void SYS_SwitchFiber(u32 arg0, u32 arg1, u32 arg2, u32 arg3, u32 pc, u32 newsp);
voidptr SYS_GetArena1Lo();
void SYS_SetArena1Lo(voidptr newlo);
voidptr SYS_GetArena1Hi();
void SYS_SetArena1Hi(voidptr newhi);
u32 SYS_GetArena1Size();
sys__Resetcallback SYS_SetResetCallback(sys__Resetcallback cb);
u32 SYS_ResetButtonDown();
u64 SYS_Time();
void sys__kprintf(Array_i8_ptr str);
VV_LOCAL_SYMBOL voidptr main__memalign(u32 , u32 );
VV_LOCAL_SYMBOL void main__main(void);
VV_LOCAL_SYMBOL f32 anon_fn_aa4c3c73e99943ac___f32_1336(void);
...
IError _const_none__; // inited later
 ...
 gx__WGPipe* VWEAK  wgPipe; // global4

Array_fixed_int_24 cube = {-30, 30, -30, 30, 30, -30, 30, 30, 30, -30, 30, 30, 30, -30, -30, 30, -30, 30, -30, -30, 30, -30, -30, -30}; // fixed array const
Array_fixed_int_24 colors = {100, 10, 100, 255, 240, 0, 0, 255, 255, 180, 0, 255, 255, 255, 0, 255, 10, 120, 40, 255, 0, 20, 100, 255}; // fixed array const
 u32 VWEAK  curr_fb = ((u32)(0U)); // global4

 u32 VWEAK  first_frame = ((u32)(1U)); // global4
...
VNORETURN VV_LOCAL_SYMBOL void panic_debug(int line_no, string file, string mod, string fn_name, string s) {
	...
	#else
	{
		...
		eprintln( str_intp(2, _MOV((StrIntpData[]){{_SLIT("   v hash: "), /*115 &string*/0xfe10, {.d_s = _SLIT("050344a")}}, {_SLIT0, 0, { .d_c = 0 }}})));
		eprintln(_SLIT("========================================="));
		#if defined(_VNATIVE)
		{
			exit(1);
...
string string_replace_each(string s, Array_string vals) {
	...
	qsort(idxs.data, idxs.len, idxs.element_size, (int (*)(const void *, const void *))&compare_10994457055883448334_RepIndex_by_idx);
	u8* b = malloc_noscan((int)(new_len + 1));
	int idx_pos = 0;
...
_option_multi_return_string_string string_rsplit_once(string s, string delim) {
	...
	_option_multi_return_string_string _t2;
	_option_ok(&(multi_return_string_string[]) { (multi_return_string_string){.arg0=(*(string*)array_get(result, 1)), .arg1=((string*)result.data)[0]} }, (_option*)(&_t2), sizeof(multi_return_string_string));
	return _t2;
}
...
// Attr: [c]
gx__GXDrawDoneCallback GX_SetDrawDoneCallback(void (*cb)(void));

// Attr: [c]
gx__GXBreakPtCallback GX_SetBreakPtCallback(void (*cb)(void));
...
// TypeDecl
// Attr: [c]
voidptr VIDEO_GetNextFramebuffer(void);

// Attr: [c]
voidptr VIDEO_GetCurrentFramebuffer(void);
...
// Attr: [c]
voidptr SYS_GetArena1Lo(void);

// Attr: [c]
void SYS_SetArena1Lo(voidptr newlo);

// Attr: [c]
voidptr SYS_GetArena1Hi(void);
...
VV_LOCAL_SYMBOL void main__main(void) {
	Array_voidptr xfb = new_array_from_c_array(2, 2, sizeof(voidptr), _MOV((voidptr[2]){((voidptr)(0)), ((voidptr)(0))}));
	f32 yscale = ((f32)(0.0));
	u32 xfbheight = ((u32)(0U));
	Array_int* v = HEAP(Array_int, new_array_from_c_array(1, 1, sizeof(int), _MOV((int[1]){4})));
	anon_fn_aa4c3c73e99943ac___f32_1336;
	Array_int* p = HEAP(Array_int, new_array_from_c_array(1, 1, sizeof(int), _MOV((int[1]){4})));
	anon_fn_aa4c3c73e99943ac___f32_1369;
	gx__GXColor background = ((gx__GXColor){.r = 0,.g = 0,.b = 0,.a = 255,});
	VIDEO_Init();
	gx__GXRModeObj* rmode = VIDEO_GetPreferredMode((((voidptr)(0))));
	curr_fb = 0U;
	first_frame = 0U;
	...
	VIDEO_SetNextFramebuffer((*(voidptr*)array_get(xfb, curr_fb)));
	if (!first_frame) {
		VIDEO_SetBlack(0);
	}
	VIDEO_Flush();
	VIDEO_WaitVSync();
	if ((rmode->viTVMode & 1U)) {
		VIDEO_WaitVSync();
	}
	GX_Init(gp_fifo, (262144));
	GX_SetCopyClear(background, 16777215U);
	GX_SetViewport(0, 0, rmode->fbWidth, rmode->efbHeight, 0, 1);
	yscale = GX_GetYScaleFactor(rmode->efbHeight, rmode->xfbHeight);
	xfbheight = GX_SetDispCopyYScale(yscale);
	GX_SetScissor(0U, 0U, rmode->fbWidth, rmode->efbHeight);
	GX_SetDispCopySrc(0U, 0U, rmode->fbWidth, rmode->efbHeight);
	GX_SetDispCopyDst(rmode->fbWidth, xfbheight);
	GX_SetCopyFilter(rmode->aa, rmode->sample_pattern, 1, (voidptr)&/*qq*/rmode->vfilter);
	GX_SetFieldMode(rmode->field_rendering, (((rmode->viHeight == 2 * rmode->xfbHeight) ? (1) : (0))));
	GX_SetCullMode(0);
	GX_CopyDisp((*(voidptr*)array_get(xfb, curr_fb)), 1);
	GX_SetDispCopyGamma(0);
	gx__GuVector cam = ((gx__GuVector){.x = 0.0,.y = 0.0,.z = 0.0,});
	gx__GuVector up = ((gx__GuVector){.x = 0.0,.y = 1.0,.z = 0.0,});
	gx__GuVector look = ((gx__GuVector){.x = 0.0,.y = 0.0,.z = -1.0,});
	guLookAt(v, &cam, &up, &look);
	u16 w = rmode->viWidth;
	u16 h = rmode->viHeight;
...
VV_LOCAL_SYMBOL void main__draw_cube(Array_fixed_anon_fn___f32_4 v) {
	...
	main__draw_quad(0, 1, 4, 7, 2);
	main__draw_quad(1, 2, 5, 4, 3);
	main__draw_quad(2, 3, 6, 5, 4);
	main__draw_quad(4, 7, 6, 5, 5);
	GX_End();
}
...
void _vinit(int ___argc, voidptr ___argv) {
	...
	wgPipe = *(gx__WGPipe**)&((gx__WGPipe*[]){0}[0]); // global
}
void _vcleanup(void) {
}
